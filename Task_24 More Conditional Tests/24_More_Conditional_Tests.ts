...
// let myName = "Aftab";
// console.log(myName == "Aftab");             //true          equal to
// console.log(myName !== "aftab");              //true          not equal to
...
// console.log(myNumber > 5);          //false          greater than or equal to
